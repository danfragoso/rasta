...
//PlotLine - This is the bresenhan algorithm
// Full implementation can be found at https://github.com/StephaneBunel/bresenham
func PlotLine(img draw.Image, x1, y1, x2, y2 int) {
